package com.tingyu.xblog.app.core;
 ...
 * @author johnniang
 */
@RestControllerAdvice(value = {"com.tingyu.xblog.app.controller.admin.api", "com.tingyu.xblog.app.controller.content.api"})
@Slf4j
public class ControllerExceptionHandler {
    ...
    @ExceptionHandler(XBlogException.class)
    public ResponseEntity<BaseResponse> handleHaloException(XBlogException e) {
