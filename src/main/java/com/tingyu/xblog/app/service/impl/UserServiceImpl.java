...
import com.tingyu.xblog.app.model.params.UserParam;
import com.tingyu.xblog.app.repository.UserRepository;
...
public class UserServiceImpl extends AbstractCrudService<User, Integer> implements UserService {
    ...
    public User updatePassword(String oldPassword, String newPassword, Integer userId) {
        ...
        // Log it
        eventPublisher.publishEvent(new LogEvent(this, updatedUser.getId().toString(), LogType.PASSWORD_UPDATED, XBlogUtils.desensitize(oldPassword, 2, 1)));
    ...
    public void mustNotExpire(User user) {
        ...
        if (user.getExpireTime() != null && user.getExpireTime().after(now)) {
            ...
            // If expired
            throw new ForbiddenException("账号已被停用，请 " + XBlogUtils.timeFormat(seconds) + " 后重试").setErrorData(seconds);
        }
    }
