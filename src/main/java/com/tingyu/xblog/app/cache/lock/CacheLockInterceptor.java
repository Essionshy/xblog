package com.tingyu.xblog.app.cache.lock;

import com.tingyu.xblog.app.cache.StringCacheStore;
import com.tingyu.xblog.app.exception.FrequentAccessException;
...
public class CacheLockInterceptor {
    ...
    @Around("@annotation(com.tingyu.xblog.app.cache.lock.CacheLock)")
