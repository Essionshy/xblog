...
import com.tingyu.xblog.app.core.PageJacksonSerializer;
import com.tingyu.xblog.app.factory.StringToEnumConverterFactory;
import com.tingyu.xblog.app.model.support.XBlogConst;
import com.tingyu.xblog.app.security.resolver.AuthenticationArgumentResolver;
...
import static com.tingyu.xblog.app.utils.XBlogUtils.*;
...
@Slf4j
@Configuration
@ComponentScan(basePackages = "com.tingyu.xblog.app.controller")
...
public class WebMvcAutoConfiguration extends WebMvcConfigurationSupport {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        String workDir = FILE_PROTOCOL + ensureSuffix(XBlogProperties.getWorkDir(), FILE_SEPARATOR);
        ...
        String uploadUrlPattern = ensureBoth(XBlogProperties.getUploadUrlPrefix(), URL_SEPARATOR) + "**";
        String adminPathPattern = ensureSuffix(XBlogProperties.getAdminPath(), URL_SEPARATOR) + "**";
     ...
     */
    @Bean
    public FreeMarkerConfigurer freemarkerConfig(XBlogProperties XBlogProperties) throws IOException, TemplateException {
        FreeMarkerConfigurer configurer = new FreeMarkerConfigurer();
        configurer.setTemplateLoaderPaths(FILE_PROTOCOL + XBlogProperties.getWorkDir() + "templates/", "classpath:/templates/");
        ...
        if (XBlogProperties.isProductionEnv()) {
    ...
    public void configureViewResolvers(ViewResolverRegistry registry) {
        ...
        resolver.setSuffix(XBlogConst.SUFFIX_FTL);
    ...
    protected RequestMappingHandlerMapping createRequestMappingHandlerMapping() {
        return new HaloRequestMappingHandlerMapping(XBlogProperties);
    }
    ...
    private static class HaloRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
        ...
        public HaloRequestMappingHandlerMapping(XBlogProperties XBlogProperties) {
            this.XBlogProperties = XBlogProperties;
        ...
        private void initBlackPatterns() {
            String uploadUrlPattern = ensureBoth(XBlogProperties.getUploadUrlPrefix(), URL_SEPARATOR) + "**";
            String adminPathPattern = ensureBoth(XBlogProperties.getAdminPath(), URL_SEPARATOR) + "?*/**";
