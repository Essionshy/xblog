...
public class SwaggerConfiguration {
    ...
    public SwaggerConfiguration(XBlogProperties XBlogProperties) {
    ...
    public Docket haloDefaultApi() {
        ...
        return buildApiDocket("com.tingyu.xblog.app.content.api",
            "com.tingyu.xblog.app.controller.content.api",
            "/api/content/**")
            .securitySchemes(contentApiKeys())
            .securityContexts(contentSecurityContext())
            .enable(!XBlogProperties.isDocDisabled());
    }
    ...
    public Docket haloAdminApi() {
        ...
        return buildApiDocket("com.tingyu.xblog.app.admin.api",
            "com.tingyu.xblog.app.controller.admin",
            "/api/admin/**")
