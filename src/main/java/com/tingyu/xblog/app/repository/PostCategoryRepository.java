...
public interface PostCategoryRepository extends BaseRepository<PostCategory, Integer> {
    ...
    @Query("select new com.tingyu.xblog.app.model.projection.CategoryPostCountProjection(count(pc.postId), pc.categoryId) from PostCategory pc group by pc.categoryId")
    @NonNull
