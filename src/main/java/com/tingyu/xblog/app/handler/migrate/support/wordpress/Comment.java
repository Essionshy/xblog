package com.tingyu.xblog.app.handler.migrate.support.wordpress;

import com.alibaba.fastjson.annotation.JSONField;
import lombok.Data;
import com.tingyu.xblog.app.handler.migrate.utils.PropertyMappingTo;

/**
 * <p>
 * WordPress导出的xml中对于的comment节点下的子节点值将被映射为该类的属性,
 * 最终会被转换为{@link com.tingyu.xblog.app.model.entity.PostComment}
 * </p>
 *
 * @author guqing
 * @author ryanwang
