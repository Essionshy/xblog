package com.tingyu.xblog.app.controller.core;
...
import com.tingyu.xblog.app.utils.FilenameUtils;
...
public class CommonController extends AbstractErrorController {
    ...
    private void handleCustomException(@NonNull HttpServletRequest request) {
        ...
        if (throwable instanceof NestedServletException) {
            ...
            if (rootCause instanceof XBlogException) {
                XBlogException XBlogException = (XBlogException) rootCause;
                request.setAttribute("javax.servlet.error.status_code", XBlogException.getStatus().value());
                request.setAttribute("javax.servlet.error.exception", rootCause);
                request.setAttribute("javax.servlet.error.message", XBlogException.getMessage());
            }
